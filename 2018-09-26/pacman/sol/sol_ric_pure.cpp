...
int ric(int r, int c, int b) {
  // returns the number of paths starting from cell mappa[0][0] and arriving to cell mappa[i][j] with b units of residual blue (can still eat b ghosts after leaving cell mappa[i][j] without encountering any pills)
